...
Route::group(['middleware' => 'Revalidate'], function () {
    Route::group(['middleware' => 'Authenticate'], function () {
        ...
        Route::get('/history', ['as' => 'sales.showListSales', 'uses' => 'backend\SalesController@showListSales']);
        //Route::get('/history', ['as' => 'sales.showDateRange', 'uses' => 'backend\SalesController@showDateRange']);
        ...
        Route::get('/history-export', 'backend\SalesController@exportCsv');
        Route::get('/product-print', 'backend\SalesController@productprint');
        Route::post('/get-money', ['as' => 'sales.getMoney', 'uses' => 'backend\SalesController@getMoney']);
        Route::get('/reset-money', ['as' => 'sales.resetDelete', 'uses' => 'backend\SalesController@resetDelete']);
        Route::post('/sales-money', ['as' => 'sales.money', 'uses' => 'backend\SalesController@money']);
        Route::post('/history/set-date-range', ['as' => 'sales.setSpecificSale', 'uses' => 'backend\SalesController@setSpecificSale']);
        Route::get('/history/reset-date-range',['as' => 'sales.resetStatus', 'uses' => 'backend\SalesController@resetStatus']);
    });
});
